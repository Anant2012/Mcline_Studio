  ...
  const getData = async () => {
    try {
      const response = await AxiosInstance.get(
        `/api/hr/get/personal/${userId}`
      );
      if (response.status === 200) {
        console.log(response.data.data[0].personal_details);
        setPersonal_contact_number(
          response.data.data[0].personal_details.personal_contact_number
        );
        setPersonal_email_id(
          response.data.data[0].personal_details.personal_email_id
        );
        setOfficial_email_id(
          response.data.data[0].personal_details.official_email_id
        );
        ...
        setReporting_manager(
          response.data.data[0].personal_details.reporting_manager
        );
        ...
        setJoining_date(
          moment(response.data.data[0].personal_details.joining_date).format(
            "YYYY-MM-DD"
          )
        );
        setBlood_group(response.data.data[0].personal_details.blood_group);
        setEmergency_contact_number(
          response.data.data[0].personal_details.emergency_contact_number
        );

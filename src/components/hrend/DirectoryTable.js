    ...
    return (
        <>
            <div class="flex flex-wrap mx-auto mt-20 w-3/4">
                ...
                <div
                    class="w-full flex-col sm:flex-row p-2  flex item-center flex text-white justify-end bg-[#0483c8] rounded-full ">
                    ...
                    <div class="flex flex-row justify-center pr-8 items-center relative">
                        <label for="name" class="my-auto px-4 pr py-3 title-font tracking-wider  text-sm decoration-white">
                            Search
                        </label>
                        <input type="text" onChange={(e) => onSearch(e.target.value)}
                            id="name"
                            name="name"
                            class="w-full bg-gray-100 bg-opacity-5 rounded border border-gray-300 focus:border-indigo-500

...
function AdminProject() {
  ...
  const columns = [
    {
      name: "User Name",
      selector: (row) => <button onClick={() => EditProject(row)}>{row.user_id?.username}</button>,
      sortable: true,
      width: "160px",
    },
    {
    ...
    {
      name: "Resource Rate",
      selector: (row) => <button onClick={() => EditProject(row)}>{row.invoice.resource_rate}</button>,
      sortable: true,
      width: "160px",
    },
    {
      name: "Resource Cost",
      selector: (row) => <button onClick={() => EditProject(row)}>{row.invoice.resource_cost}</button>,
      sortable: true,
      width: "160px",
    },
    {

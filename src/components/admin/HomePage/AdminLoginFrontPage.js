...
const AdminLoginFrontPage = (props) => {
  ...
  return (
    <>
      ...
      <div className={`${(props.adminLogin)?"hidden":"block"} h-[500px]  w-full sm:w-3/4 flex mx-auto sm:shadow-md my-12`}>
...
export default AdminLoginFrontPage
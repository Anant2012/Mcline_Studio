        ...
        <>
            <div className={`${(props.viewFillProfile) ? "block" : "hidden"}`}>
                ...
                <div className="w-full flex justify-center">
                    <button onClick={EditPersonalDetails} disabled={isDisabled} style={{ cursor: isDisabled ? "not-allowed" : "pointer" }} className="mx-auto w-11/12 sm:w-3/4 text-white bg-indigo-500 mt-4 mb-12 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Submit</button>
                </div>
            </div>
        </>
    );

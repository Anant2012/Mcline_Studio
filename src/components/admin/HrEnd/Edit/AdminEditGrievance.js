                        ...
                        <form onSubmit={EditGrievance}>
                            <div className="w-3/4 mx-auto">
                                <div className="flex flex-wrap -m-2">
                                    ...
                                    <div className="p-2 w-full sm:w-1/2">
                                        <div className="relative">
                                            <label for="cars" className="leading-7 text-sm text-gray-600">Grievance Status</label>

                                            <select value={grievance_status}
                                                onChange={(e) => setGrievance_status(e.target.value)} name="grievance_status" id="grievance_status" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out">

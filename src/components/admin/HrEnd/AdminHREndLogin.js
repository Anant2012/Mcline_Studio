      ...
      <div className={`${(props.hrLogin)?"hidden":"block"} h-[500px]  w-full sm:w-3/4 flex mx-auto sm:shadow-md my-12`}>
        ...
        <div className='w-full lg:w-1/2 my-auto'>
          ...
          <div className='w-3/4 mx-auto'>
            ...
            <button onClick={()=>{props.setHrLogin=1}} className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">LogIn</button>

              ...
              <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full sm:w-1/2">
                  <div class="relative">
                    ...
                    <select name="lead_status" id="lead_status" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out">

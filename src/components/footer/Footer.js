...
function Footer() {
  ...
  return (
    <footer className=" w-full bg-sky-100/75 text-gray-600 body-font">
  <div className="container px-5 w-full py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
